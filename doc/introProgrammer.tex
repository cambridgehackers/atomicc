...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \begin{tikzpicture}
        [auto,title/.style={font=\fontsize{18}{18}\color{black!45}},
        ...
        \node [server] (cpu1) at (7.65,8.3) {CPU};
        \node [server] (cpu2) at ($(cpu1) + (270:1)$){CPU};
        ...
        \draw[->] (c1) -- (c1-|sched.north);
        \draw[->] (c2) -- (c2-|sched.north);
        \draw[->] (c3) -- (c3-|sched.north);
        \draw[->] (sched.south) -- (sched.south-|cpu1.west);
        \draw[->] (sched.south) -- (sched.south-|cpu2.west);
    \end{tikzpicture}
