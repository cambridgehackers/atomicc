...
stall scheduling of the calling transaction until all necessary elements are
available.
...
In Dave\cite{Dave2007}, there is a quite complete discussion and analysis 
of the current state and future directions of Bluespec scheduling.
