...
To facilitate program analysis, all operations on state elements are grouped into transactions.
Transactions are a group of operations that transform state elements from one consistent state to another.
Transactions follow ACID semantics.  Scheduling of rules guarantees 'Isolation'.
...
Transactions permit packing a set of logical actions into a unit so that users
do not need to work about conflicts and the system knows how to execute multiple
units concurrently.  (6.830, lec 12)
