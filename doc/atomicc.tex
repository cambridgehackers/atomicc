...
%In data structure design, heavy use is made of inheritance and subclassing
%in creating both data structure declarations and in defining methods usable
%to perform operations on the class.
...
\rSec2[atomicc.interface]{Interfaces}
...
\rSec2[atomicc.interface]{Interactions between modules}
...
\rSec2[atomicc.synthesis]{Modular synthesis}
