...
\DeclareMathOperator*{\ORop}{\mathlarger \bigvee}
\DeclareMathOperator*{\ANDop}{\mathlarger \bigwedge}
...
\appendix
%% \include{lpmExample}
%% \include{introProgrammer}
%% \include{grammar}
%%not needed \include{schedule}
%% \include{cpp-grammar}
\include{ir}

\bibliographystyle{IEEEtran}
\bibliography{references,bs-related-papers}
